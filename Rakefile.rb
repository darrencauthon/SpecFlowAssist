...
SOLUTION_FILE = "\"#{SOLUTION_ROOT}\\src\\SpecFlowAssist.sln\""

BIN_DIRECTORY = "#{SOLUTION_ROOT}\\src\\SpecFlowAssist\\bin\\Release"

DEPLOY_DIRECTORY = "#{SOLUTION_ROOT}\\deploy"
DEPLOY_FILE =  "#{DEPLOY_DIRECTORY}\\SpecFlowAssist.dll"
...
desc "Create the SpecFlowAssist.dll in /deploy"
...
task :clean_deploy do
	File.delete "#{DEPLOY_DIRECTORY + "/SpecFlowAssist.dll"}" if File.exists?(DEPLOY_DIRECTORY + "/SpecFlowAssist.dll")
	File.delete "#{DEPLOY_DIRECTORY + "/SpecFlowAssist.pdb"}" if File.exists?(DEPLOY_DIRECTORY + "/SpecFlowAssist.pdb")
